...
def test_mint_control():
  ...
  expected_metadata2 = 'A.{contract}.AsyncArtwork.NFTMetadata(id: 3, isMaster: false, uri: "<uri>", isUriLocked: false, platformSecondSalePercentage: 0.01000000, numControlLevers: nil, numRemainingUpdates: 5, owner: {owner}, levers: {levers}, uniqueTokenCreators: [])'.format(contract=address("AsyncArtwork")[2:], owner=address("User3"), levers='{}')
