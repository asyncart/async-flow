...
def unwhitelist_currency(arg, signer, should_succeed):
...
def test_prepare_blueprint():
  ...
  unwhitelist_currency("A.f8d6e0586b0a20c7.FUSD.Vault", "User1", False)
  ...
  unwhitelist_currency("A.f8d6e0586b0a20c7.FUSD.Vault", "AsyncArtAccount", True)
