...
def create_default_nft_art_auction(args, signer, should_succeed, expected_auction_result=None):
  ...
  if should_succeed:
    assert send_transaction("createDefaultArtAuction", args=auction_args, signer=signer)
    ...
    assert not send_transaction("createDefaultArtAuction", args=auction_args, signer=signer)
...
def test_make_default_nft_art_auction():
  ...
  create_default_nft_art_auction(
    ["2", "A.0ae53cb6e3f42a79.FlowToken.Vault", "2.0", "5.0", [], []],
    "User1",
    False
  )
  ...
  create_default_nft_art_auction(
    ["1", "A.0ae53cb6e3f42a79.FlowToken.Vault", "4.1", "5.0", [], []],
    "User1",
    False
  )
  ...
  create_default_nft_art_auction(
    ["1", "A.0ae53cb6e3f42a79.FlowToken.Vau", "2.1", "5.0", [], []],
    "User1",
    False
  )
  ...
  create_default_nft_art_auction(
    ["1", "A.0ae53cb6e3f42a79.FlowToken.Vau", "2.1", "5.0", ["User2"], ["105.0"]],
    "User1",
    False
  )
  ...
  # Attempt to make art auction with an invalid sum of fee percentages (over 100)
  create_default_nft_art_auction(
    ["1", "A.0ae53cb6e3f42a79.FlowToken.Vau", "2.1", "5.0", ["User2", "User3"], ["10.0", "95.0"]],
    "User1",
    False
  )
  ...
  create_default_nft_art_auction(
    ["1", "A.0ae53cb6e3f42a79.FlowToken.Vau", "2.1", "5.0", ["User2"], ["1.0", "95.0"]],
    "User1",
    False
  )
  ...
  create_default_nft_art_auction(
    ["1", "A.0ae53cb6e3f42a79.FlowToken.Vau", "2.1", "5.0", ["User2", "User3"], ["95.0"]],
    "User1",
    False
  )
