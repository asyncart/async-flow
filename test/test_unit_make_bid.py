...
def make_bid(args, signer, should_succeed, expected_result=None):
  ...
  if should_succeed:
    ...
    result = send_script_and_return_result("getAuction", args=[["String", "A.01cf0e2f2f715450.AsyncArtwork.NFT"], ["UInt64", args[0]]])
    print(result)
...
# This test is WIP pending contract upgrades
#@pytest.mark.core
