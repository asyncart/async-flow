...
def test_change_default_blueprint_secondary_fee_percentage():
  ...
  assert 0.075 == float(send_blueprints_script_and_return_result("getDefaultBlueprintSecondaryFeePercentage"))

  # Change the default blueprint secondary fee percentage
  change_default_blueprint_secondary_fee_percentage("0.05", "AsyncArtAccount", True)

  # Confirm that the new default blueprint secondary fee percentage is 5.0
  assert 0.05 == float(send_blueprints_script_and_return_result("getDefaultBlueprintSecondaryFeePercentage"))
  ...
  change_default_blueprint_secondary_fee_percentage("0.98", "AsyncArtAccount", False)
